...
<body>
	...
	<header>
    	...
    	<div id="menu">
        	<ul>
            	<a href="?index=monan"><li style="border-left:1px solid #999;width:180px;">Quản lý món ăn</li></a>
    ...
    <div id="wrapper">
        <div id="content2">
			<?php 
				...
				switch($index){
					case "suatin":
					include_once("index/suatin.php");
					break;					
					case "suamonan":
					include_once("index/suamonan.php");
					break;
					case "monan":
					include_once("index/quanlymonan.php");
					break;					
					case "tintuc":
					include_once("index/quanlytintuc.php");
					break;
					case "themmonan":
					include_once("index/themmon.php");
					break;
					case "themtin":
					include_once("index/themtin.php");
					break;
					case "chitietmon":
					include_once("index/chitietmon.php");
					break;
					case "chitiettin":
					include_once("index/chitiettin.php");
					break;																									
					default:
					include_once("index/quanlygopy.php");				
				}
			?>
        </div>
        <footer>
