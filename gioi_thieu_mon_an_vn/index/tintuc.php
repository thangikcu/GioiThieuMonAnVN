...
<div id="cacmon">
    ...
    ?>
        <li>
            ...
            <div class="title">
				<div class="ttt"><?php echo $row['tieu_de']; ?></div>
            	<p><?php echo $row['khai_quat']; ?></p>
                <div class="ct"><a href="?index=chitiettin&id=<?php echo $row['id']; ?>">Xem thêm ></a></div>
                <p style="font-size:10px;margin-top:30px;">( <?php echo $row['ngay_dang']; ?> )</p>
            </div>
        </li>
    <?php
        }
